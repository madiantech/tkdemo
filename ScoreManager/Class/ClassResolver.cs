...
namespace net.tkcore
{
    ...
    [Resolver(Author = "TKCore", CreateDate = "2020-10-29",
        Description = "Class(Class)的数据访问层类")]
    public class ClassResolver : Tk5TableResolver
    {
        internal const string DATAXML = "Class/Class.xml";
        ...
        public ClassResolver(IDbDataSource source)
            : base(DATAXML, source)
        {
            AutoUpdateKey = true;
        }
